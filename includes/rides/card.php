<div class="rd-card" id="rd-card">
    ...
    <div class="rd-top-container">
        <a href="<?= 'ride/' .$ride->id;?>" class="fullwidth"> <?php
            ...
            <div class="rd-image" style="background-image: url(<?= $ride->getFeaturedImage()->url; ?>); background-color: lightgrey">
                <div class="rd-ride-title"><?= $ride->name; ?></div>
                <div class="rd-ride-date"><?= $ride->date; ?></div>
            </div>
        </a> <?php
