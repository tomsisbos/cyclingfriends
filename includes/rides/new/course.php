	...
	<form id='form' class="container smaller inner" method="POST" action="<?= $base_uri . (CFG_STAGE_ID + 1) ?>">
				...
				<div class="mb-3 row g-2">
					...
					<div class="col-md">
						...
						<select class="form-select" id="terrain" name="terrain">
							<option <?php if($_SESSION['forms'][CFG_STAGE_ID]['terrain'] == '1') {echo 'selected';} ?> value="1">平坦</option>
							<option <?php if($_SESSION['forms'][CFG_STAGE_ID]['terrain'] == '2') {echo 'selected';} ?> value="2">多少の坂あり</option>
							<option <?php if($_SESSION['forms'][CFG_STAGE_ID]['terrain'] == '3') {echo 'selected';} ?> value="3">坂あり</option>
							<option <?php if($_SESSION['forms'][CFG_STAGE_ID]['terrain'] == '4') {echo 'selected';} ?> value="4">山岳</option>
						</select>
					</div>
				</div>
				<div class="mb-3">
		...
		<div id="js-draw" style="display: none;">
			...
			<div class="rd-course-fields"> <?php
				...
				<div class="mb-3">
					<label class="form-label required">コース紹介</label>
					<textarea class="form-control" id="courseDescriptionTextarea"><?= $_SESSION['forms'][CFG_STAGE_ID]['course-description']; ?></textarea>
				</div>
