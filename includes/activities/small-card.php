...
<a class="acsm-container interactive" href="/activity/<?= $activity->id ?>">
    ...
    <div class="acsm-infos">
        ...
        <div class="acsm-line"><div class="acsm-distance">距離 : <?= round($activity->route->distance, 1) ?>km</div><div class="acsm-duration">時間 : <?= $activity->duration->h. 'h' .$activity->duration->i ?></div></div>
