    ...
    [
        ...
        'content' => [
            [
                'title' => '基本操作',
                'text' => [
                    '作成または編集中のルートは、緑色で表示されるスタートポイント、赤色で表示されるゴールポイント、そして白色で表示されるウェイポイントで区切られます。クリックの操作結果は、下記の' .Manual::ref('routes-buildmode', '作成モード'). 'によって異なりますが、共通しているのは、ウェイポイントを長押しクリックすると、位置を細かく変えることができることです。ウェイポイントに変更が生じると、その前後の区間が計算方法に従って再計算されます。'
                ],
            ],
            [
                'title' => '作成ツール',
