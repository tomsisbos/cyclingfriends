...
$content = [
    [
        ...
        'content' => [
            ...
            [
                'title' => '作成ツール',
                'text' => [
                    'ルート作成用の地図では、' .Manual::ref('world', 'サイクルガイドマップ'). 'のデフォルト設定に加え、「作成ツール」の設定部門が表示されています。この設定部門では、ルート作成の方法や、ルート作成に関する様々な操作を行うことができます。'
                ],
                'content' => [
                    [
                        'title' => '編集モード',
                    ...
                    [
                        ...
                        'content' => [
                            ...
                            [
                                'title' => '2.	小道を優先する',
                                'text' => [
                                    'デフォルトのアルゴリズムでは、幹線道路が優先されます。小道を優先するオプションにチェックを入れると、細かい道を優先するアルゴリズムに切り替えます。未舗装路や車両の通行できない区間等をたどりたい場合などに役立ちます。'
                                ]
                            ]
                        ]
                    ],
    ...
    [
        ...
        'text' => [
            ...
            'ルート設定が「公開」となっている場合、このページは誰にでも閲覧できます（サインインされていないユーザーを含む）。但し、作成者がプレミアムユーザーである場合の除き、サインインされていないユーザーに表示される地図は静的地図になります。'
        ],
        'content' => [
            [
                'title' => 'ヘッダー',
            ...
            [
                ...
                'text' => [
                    ...
                    'また、地図の下には標高図が表示されます。標高図にカーソルを乗せると、地図同様に距離、勾配と標高に加え、地図上で該当する位置も表示されます。',
            ...
            [
                'title' => 'コース上のPOI一覧',
                'text' => [
                    '地図と標高図の下には、コース上にあるPOI（Points Of Interest＝絶景スポット、トイレ、給水ポイント、コンビニエンスストア等)の情報が順番に表示されています。クリックすると、地図上で表示されます。'
                ]
            ],
            [
                'title' => '走行再現モード',
