                ...
                'content' => [
                    [
                        ...
                        'text' => [
                            ...
                            'このベースレイヤーを選択すると、選択する時期によって、地図のディスプレイ（色合い等）' .Manual::temp('のみならず、表示されるデータが変わるようになっています。例えば、絶景スポットはその季節の写真が優先的に表示されたり、おススメの季節と一致しているセグメントが色分けで表示されたりします。'),
                ...
                'content' => [
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            Manual::temp('公平性を担保するために、管理者は絶景スポットを評価することができません。')
                        ]
                    ],
                    [
                        'title' => '紹介文',
                ...
                'content' => [
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => '難易度の計算式の中で最も反映されるのはコース距離に対する高低差です。',
                            'point' => 'あくまでも紹介されているコース方向に基づいた数字なので、逆方向の場合は数字が異なります。'
