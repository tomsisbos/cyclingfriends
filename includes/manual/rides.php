    ...
    [
        ...
        'content' => [
            [
                ...
                'content' => [
                    ...
                    [
                        'title' => '参加人数',
                        'text' => [
                            '最低催行人数（1名から）と定員' .Manual::temp('（7名まで）'). 'を指定します。',
                            'point' => Manual::temp('公道で行われる関係で、一つの集団で安全に走行できる人数を８名と考え、募集可能最大人数を原則として7名を上限とさせていただいております。しかし、「CyclingFriends公認ガイド」申請をして頂ければ、最大30名までに拡大することができます。')
                        ]
                    ],
                    [
                        'title' => '参加対象',
            ...
            [
                'title' => '➂ コース情報の入力',
                'text' => [
                    'ライドを作成する前には、サマリーページにて、記入した詳細が正しいかどうか、記入漏れがないかどうかを確認します。' .Manual::temp('記入漏れがある場合は、記入漏れがあった情報欄が赤で強調されます。'),
                ],
                'content' => [
                    [
                        'title' => 'ハイライト画像の設定',
        ...
        'content' => [
            [
                ...
                'text' => [
                    ...
                    'point' => Manual::temp('ライドに参加するには、実名情報（' .Manual::ref('user-settings-realname', '非公開に設定することは可能'). '）と生年月日情報の入力が必要になります。プロフィールページで設定していない場合、入力できるモーダルウィンドウが表示されます。')
                ]
            ],
            [
                'title' => '参加者パネル',
