                ...
                'content' => [
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => '上記の項目にない特定の確認事項や、参加者から特定の情報を記入していただきたい場合は、ライド作成後の' .Manual::ref('rides-admin-panel', 'ライドの管理'). 'にて指定していただけます。'
                        ]
                    ]
                ]
            ],
        ...
        'content' => [
            [
                ...
                'text' => [
                    ...
                    'point' => 'ライドに参加するには、実名情報（' .Manual::ref('user-realname', '非公開に設定することは可能'). '）と生年月日情報の入力が必要になります。プロフィールページで設定していない場合、入力できるモーダルウィンドウが表示されます。'
                ]
            ],
            [
                'title' => '参加者パネル',
