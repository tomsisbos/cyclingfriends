...
$intro = [
    'CyclingFriendsで大切にしている「リモート」と「リアル」の中間にあるのは、「ツアー開催機能」です。集合場所、対象レベルや人数等、そしてコースやツアー内容を入力さえすれば、告知ページが自動的に作成されます。ユーザーの所在地や特徴を考慮したアルゴリズムを介して、条件を満たすユーザーに表示されるほか、サイクルガイドマップ上にも表示されます。',
...
$content = [
    [
        ...
        'text' => [
            '新規ツアーの作成と既存ツアーの編集は、①基本情報の設定、②コースの設定、③入力情報の確認という3つのステップを経て行われます。作成されたツアーの管理に関しては、' .Manual::ref('rides-admin', 'ツアーの管理'). 'をご確認ください。',
        ...
        'content' => [
            [
                ...
                'content' => [
                    [
                        'title' => 'タイトル',
                        'text' => [
                            'ツアーの名称を最初に入力します。掲示板等で最初に目に入るものなので、少ない文字数でツアーの内容や魅力が分かりやすく伝わるタイトルが好ましいです。'
                        ]
                    ],
                    [
                        'title' => '開催時間',
                    ...
                    [
                        'title' => '紹介文の作成',
                        'text' => [
                            'ツアーの全体紹介や、ツアーに関する総合的な案内を詳細に記載します。',
                            'point' => [
                                'コースに関する詳細案内は、②コースの設定にある紹介文の記入欄で記入することになっています。',
                                '上記の項目にない特定の確認事項や、参加者から特定の情報を記入していただきたい場合は、ツアー作成後の' .Manual::ref('rides-admin', 'ツアーの管理'). 'にて指定していただけます。'
                            ]
                        ]
                    ]
                ]
                            ...
                            [
                                ...
                                'content' => [
                                    [
                                        'title' => '利用用途',
                                        'text' => [
                                            'チェックポイントのみ設定する方法は、コース情報をざっくりと定めるだけなので、特定のルート情報がツアーに付随されません。集合と解散場所と大まかな内容以外、詳しいコースが定まっていないケースに適しています。'
                                        ]
                                    ],
                                    [
                                        'title' => '基本操作',
                                        'text' => [
                                            ...
                                            'point' => '集合場所と解散場所の指定にもなるため、ツアーの作成に進むには、最低でもスタートとゴールのチェックポイントを設定しなければなりません。'
                                        ]
                                    ]
                                ]
                            ],
                            [
                                ...
                                'content' => [
                                    [
                                        'title' => '利用用途',
                                        'text' => [
                                            '自分のルートの中から選ぶ方法は、ツアー情報に正確なルート情報も付随する方法です。集合場所、解散場所、距離や起伏等の情報は自動的に算出されます。また、チェックポイントの設定はコース上で行い、チェックポイントには距離の情報も自動的に付随されます。正確なコース情報を事前に把握できると、安全性と利便性の側面では主催者にとっても参加者にとってももっとも利便性が高いので、できるだけこの方法を優先しましょう。'
                                        ]
                                    ],
                                    [
                                        'title' => '基本操作',
            ...
            [
                'title' => '➂ コース情報の入力',
                'text' => [
                    'ツアーを作成する前には、サマリーページにて、記入した詳細が正しいかどうか、記入漏れがないかどうかを確認します。記入漏れがある場合は、記入漏れがあった情報欄が赤で強調されます。',
                ],
                'content' => [
                    [
                        'title' => 'ハイライト画像の設定',
                    ...
                    [
                        'title' => 'ツアーの作成',
                        'text' => [
                            '入力情報の確認が終われば「作成する」ボタンをクリックします。特に問題なければ、ツアーが作成されます。',
                            'ツアーを作成するだけで、他のユーザーからの応募を受け付けられるわけではありません。デフォルトでは、新規作成されたツアーは「非公開」設定になっており、エントリーが開始されていない状態になっているため、最初にエントリー期間を定め、プライバシーを「公開」または「友達のみ」に設定する必要があります。',
                            '自分が管理者になっているツアーを管理するには、「マイツアーページ」から「ツアー紹介ページ」にアクセスする必要があります。'
                        ]
                    ]
                ]
            ]
    ...
    [
        ...
        'text' => [
            'マイツアーページでは、管理者権限のあるツアー概要情報一覧が作成日の近い順で表示されます。ハイライト画像又は「詳細」ボタンをクリックすると、ツアー紹介ページにアクセスします。「管理」、「編集」や「削除」ボタンでワンクリックの管理操作も可能です。'
        ]
    ],
    [
        'title' => 'ツアー紹介ページ',
        ...
        'text' => [
            '紹介ページは、ツアーの概要を表示します。観覧できるかどうかは、' .Manual::ref('rides-privacy-settings', 'ツアーのプライバシー設定'). 'によります。'
        ],
        'content' => [
            [
                'title' => 'ヘッダー',
                'text' => [
                    ...
                    'point' => 'ツアーに参加するには、実名情報と生年月日情報（' .Manual::ref('user-settings-realname', '非公開に設定することは可能'). '）の入力が必要になります。プロフィールページで設定していない場合、入力できるモーダルウィンドウが表示されます。'
                ]
            ],
            [
                'title' => '参加者パネル',
                'text' => [
                    'ツアーに参加する予定のユーザーが表示されます。'
                ],
                'content' => [
                    [
                        'title' => 'プライバシー設定',
                        'id' => 'privacysettings',
                        'text' => [
                            '「公開」、「非公開」と「友達のみ」の中からツアーのプライバシーモードを設定できます。',
                            '「非公開」の場合、だれにも表示されず、参加者を募集することができません。',
                            '「友達のみ」の場合、管理者の友達リストに入っているユーザーのみツアー情報を観覧し、応募できます。',
                            '「公開」の場合、どのユーザーでも応募することができます。',
                            'point' => 'プライバシー設定が「公開」となっているツアーのみがサイクルガイドマップに表示されます。'
                        ]
                    ],
                    [
                        'title' => '募集期間',
                        'text' => [
                            'ツアー紹介ページ観覧可能のユーザーが応募できる期間を設定できます。設定した募集期間の前後には、参加ボタンが表示されません。'
                        ]
                    ]
                ]
            ],
            ...
            [
                ...
                'content' => [
                    [
                        'title' => 'チェックポイント',
                        'text' => [
                            'スタートからゴールまで、立ち寄る予定の主なスポット情報が距離と共に「チェックポイント」形式で順番に表示されるので、ツアー内容をイメージできます。クリックすると、画像がモーダルウィンドウで拡大されます。',
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => 'ツアー紹介ページからルート紹介ページにアクセスする場合、そのツアーのルートとして表示されるので、通常のルート情報に加え、チェックポイント情報も表示されます。'
                        ]
                    ]
                ]
            ],
    ...
    [
        ...
        'text' => [
            'ツアー管理ページでは、エントリーリストを確認したり、ユーザーが応募する際に主催者から徴収する情報を設定したり、' .Manual::temp('その他ツアーの細かい設定を調整したりすることができます。')
        ],
        'content' => [
            [
                'title' => 'エントリーリスト',
    ...
    [
        ...
        'text' => [
            'このページには、観覧可能なツアーが、プライバシー設定が「友達のみ」となっているツアーから、開催時間順で表示されます。'
        ],
        'content' => [
            [
                'title' => 'フィルター',
                'text' => [
                    '開催日、' .Manual::temp('開催地域'). '、参加可能車種、レベル、タイトル、募集状況、ユーザーと管理者の関係性から表示されるツアーにフィルターをかけることができます。'
                ]
            ],
            [
                'title' => 'ツアー一覧',
                'text' => [
                    'かけたフィルターに該当するツアーはその下に表示されます。'
                ]
            ]
        ]
    ]
