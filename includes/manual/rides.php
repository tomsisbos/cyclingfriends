...
$content = [
                ...
                'content' => [
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => '公道で行われる関係で、一つの集団で安全に走行できる人数を８名と考え、募集可能最大人数を原則として7名を上限とさせていただいております。しかし、「CyclingFriends公認ガイド」申請をして頂ければ、最大30名までに拡大することができます。'
                        ]
                    ],
                    [
                        'title' => '参加対象',
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => 'コースに関する詳細案内は、②コースの設定にある紹介文の記入欄で記入することになっています。',
                            'point' => '上記の項目にない特定の確認事項や、参加者から特定の情報を記入していただきたい場合は、ライド作成後の' .Manual::ref('rides-admin', 'ライドの管理'). 'にて指定していただけます。'
                        ]
                    ]
                ]
            ],
                    ...
                    [
                        ...
                        'content' => [
                            ...
                            [
                                'title' => '起伏',
                                'text' => [
                                    '「平坦」「多少の坂あり」「坂あり」「山岳」の中から指定することができます。距離情報と合わせて、対象レベルのユーザーに対して優先的に表示するために活用されるので、できるだけコースの特性を反映する起伏情報を指定しましょう。',
                                    'point' => 'ルート情報を付随する場合（Ⓐを除く方法）は自動的に算出されます。'
                                ]
                            ],
                            [
        ...
        'content' => [
            [
                ...
                'text' => [
                    ...
                    'point' => 'ライドに参加するには、実名情報（' .Manual::ref('user-settings-realname', '非公開に設定することは可能'). '）と生年月日情報の入力が必要になります。プロフィールページで設定していない場合、入力できるモーダルウィンドウが表示されます。'
                ]
            ],
            [
                'title' => '参加者パネル',
    ...
    [
        ...
        'text' => [
            'ライド管理ページでは、エントリーリストを確認したり、ユーザーが応募する際に主催者から徴収する情報を設定したり、その他ライドの細かい設定を調整したりすることができます。'
        ],
        'content' => [
            [
                'title' => 'エントリーリスト',
            ...
            [
                ...
                'text' => [
                    ...
                    'point' => '「選択式」の場合、最低でも二つ以上の選択肢の設定が必要です。',
                    '入力が終われば、「質問を追加」を選択し、質問がリストに追加されます。設定された質問は、「編集」と「削除」ボタンを使い、操作することができます。',
                    'point' => '質問を設定する前に応募したユーザーから、遡って情回答を求めることができないので、ユーザーから特定の情報を徴収したい場合は、プライバシー設定を「公開」にする前に慎重に設定しましょう。'
                ]
            ]
        ]
    ],
    [
        ...
        'content' => [
            [
                'title' => 'フィルター',
                'text' => [
                    '開催日、開催地域、参加可能車種、レベル、タイトル、募集状況、ユーザーと管理者の関係性から表示されるライドにフィルターをかけることができます。'
                ]
            ],
            [
                'title' => 'ライド一覧',
