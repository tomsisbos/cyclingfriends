                ...
                'content' => [
                    [
                        ...
                        'text' => [
                            ...
                            '2.	プライバシーの設定：この写真のプライバシー設定を指定できます。「公開」（だれにでも閲覧可能）、「限定公開」（アクティビティ紹介ページでは誰にでも閲覧できるが、データがコミュニティに共有されない）または「非公開」（自分だけしか閲覧できない）に設定することができます。',
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => 'アクティビティ自体を「非公開」に設定した場合、写真の設定はデフォルトで「非公開」に切り替わります。'
                        ]
                    ]
                ]
            ],
