                ...
                'content' => [
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => Manual::temp('ライドに応募する際に設定が必要ですが、入力するかどうかは任意ですし、入力したとしても、公開されるかどうかは' .Manual::ref('user-settings-realname', '設定ページ'). 'で指定できます。')
                        ]
                    ],
                    [
                        'title' => '性別',
                    ...
                    [
                        'title' => '最近の写真一覧',
                        'text' => [
                            'ユーザーが投稿したアクティビティ' .Manual::temp('で公開設定になっている写真'). 'の中から、直近のものが数枚表示されます。クリックすると、そのアクティビティの詳細（「…」URL）を確認することができます。'
                        ]
                    ],
                    [
                        'title' => 'バイク情報',
        ...
        'content' => [
            [
                ...
                'content' => [
                    ...
                    [
                        'title' => Manual::temp('パスワードの再発行'),
                        'text' => [
                            Manual::temp('パスワードを忘れた場合、こちらでパスワードの再発行を行うことができます。'),
                            Manual::temp('再発行を依頼した場合、新しいパスワードが登録済みのメールアドレスに送付されます。')
                        ]
                    ]
                ]
            ],
