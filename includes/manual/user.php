...
$intro = [
    'CyclingFriendsは、ユーザープロフィールで様々な情報を記入すればするほど機能性が高まります。とはいえ、流出する情報はユーザーご自身で選ぶことができるようになっています。CyclingFriendsをご利用頂く上で、情報やデータの入力方法、そしてそのデータ活用について、必ず把握するようにしましょう。',
    'CyclingFriendsに掲載されるデータの所有と活用については、' .Manual::ref('privacypolicy', 'こちら') .'をご確認ください。'
];
                ...
                'content' => [
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'point' => 'ツアーに応募する際に設定が必要ですが、入力するかどうかは任意ですし、入力したとしても、公開されるかどうかは' .Manual::ref('user-settings-realname', '設定ページ'). 'で指定できます。'
                        ]
                    ],
                    [
                        'title' => '性別',
                    ...
                    [
                        ...
                        'id' => 'location',
                        'text' => [
                            '主な活動拠点の位置情報です。原則として居住地に該当しますが、その限りではありません。他ユーザーと繋がるためや、アルゴリズムを介して紹介されるセグメント、ツアーや絶景スポットやその距離情報など、様々な機能に反映されるので、できる限り設定しましょう。'
                        ],
                        'content' => [
                            [
                                'title' => '設定方法',
                    ...
                    [
                        ...
                        'text' => [
                            ...
                            'ルート、ツアーやセグメントの表示など、様々な機能のアルゴリズムに反映されるので、できるだけ設定しましょう。',
                    ...
                    [
                        'title' => '最近の写真一覧',
                        'text' => [
                            'ユーザーが投稿したアクティビティで公開設定になっている写真の中から、直近のものが数枚表示されます。クリックすると、' .Manual:: ref('activity', 'そのアクティビティの詳細'). 'を確認することができます。'
                        ]
                    ],
                    [
                        'title' => 'バイク情報',
                        ...
                        'text' => [
                            ...
                            Manual::temp('このバイクを利用して登録したアクティビティの合計距離も表示されます。')
                        ],
                        'content' => [
                            [
                                'title' => '設定方法',
                    ...
                    [
                        'title' => '活動情報',
                        'text' => [
                            Manual::temp('総距離'). '、アクティビティ数、' .Manual::temp('過去28日間の合計距離とアクティビティ数'). '、そして直近のアクティビティの概要が表示されます。'
                        ]
                    ],
                    [
                        'title' => '権限',
            ...
            [
                ...
                'content' => [
                    ...
                    [
                        'title' => 'ユーザーネームの変更',
                        'text' => [
                            'ユーザーネームの変更はこちらの設定から可能です。但し、他ユーザーと被るようなユーザーネームはご利用頂けません。',
                        ]
                    ],
                    [
                        'title' => 'アカウント削除',
                        'text' => [
                            'お使いのアカウント、そしてアカウントに付随する全てのデータ（アクティビティ、ルートやコメントなども含む）が削除されます。一度削除されたデータは取り消しが付きませんので、ご注意ください。',
                        ]
                    ]
                ]
            ],
            [
                ...
                'content' => [
                        ...
                        'content' => [
                            ...
                            [
                                ...
                                'text' => [
                                    ...
                                    'point' => 'ただし、ツアーに参加する場合は主催者に公開されます。'
                                ]
                            ]
                        ]
                    ],
                    [
                        'title' => '接続',
                        'text' => [
                            'CyclingFriendsは、データの取り込み、活用や発信などに役立てる様々な外部サービスと接続できるようになっています。自分のお使いのサービスと接続して、最大限のポテンシャルを発揮しましょう。',
                            '接続するには、Oauthプロトコルを通じて、外部サービスのアカウント情報をご記入の上、接続を許可して頂く必要があります。'
                        ],
                        'content' => [
                            [
                                'title' => 'Twitter',
                                'id' => 'twitter',
                                'text' => [
                                    'Twitterアカウントと接続することによって、CyclingFriends上で行う活動を発信できるようになります。',
                                    'プラットフォーム上の様々なところに表示されているTwitterのアイコンをクリックすると、設定同様に接続することができます。'
                                ]
                            ],
                            [
                                'title' => 'Garmin',
                                'id' => 'garmin',
                                'text' => [
                                    'Garminに接続して頂ければ、Garmin社のサイクルコンピューターで記録したログデータをもとに、CyclingFriendsの' .Manual::ref('activity-import', '新規アクティビティを即時自動作成'). 'することができます。',
                                    '同期昨日を利用するには、CyclingFriendsのアカウントとGarmin Connectのアカウントを接続する必要があります。',
                                    '接続ボタンをクリックして頂き、Garmin社が提供する手順に従って接続を許可して頂ければ、接続されるようになります。',
                                    '接続された時点から、新しく保存されたアクティビティデータがCyclingFriendsに即時同期されるようになります。',
                                    Manual::temp('今後、アクティビティの同期のみならず、ルートの同期（作成したルートが自動的にサイクルコンピューターに同期される機能）も検討していく予定です。')
                                ]
                            ]
                        ]
                    ]
