<?php
	...
	$getRides->execute(array(":name" => '%' .$_POST['filter_name']. '%', ":datemin" => $_POST['filter_date_min'], ":datemax" =>  $_POST['filter_date_max'], ":level" => $_POST['filter_level'], ":status" => $_POST['filter_status']));
