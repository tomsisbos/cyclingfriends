...
export default class RidePopup extends Popup {
    ...
    load () {
        ...
        <div class="popup-img-container">
            <a target="_blank" href="/rides/ride.php?id=` + this.data.id + `">
        ...
        <div class="popup-content">
            <div class="popup-properties">
                ...
                <div class="">`+ this.data.date + ` - by 
                    <a target="_blank" href="/riders/profile.php?id=` + this.data.author_id + `">` + this.data.author_login + `</a>
                </div>
            </div>
        ...
        <div class="d-flex">
            <button class="mp-button bg-button m-auto">
                <a target="_blank" class="text-white" style="text-decoration: none;" href="/rides/ride.php?id=` + this.data.id + `">Check details</a>
            </button>
        </div>`)
    }
}