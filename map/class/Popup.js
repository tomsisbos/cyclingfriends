            ...
            stars.forEach( (star) => {
                ...
                star.addEventListener('click', (e) => {
                    if (numIsPair(click)) {
                        ...
                        ajaxGetRequest ('/map/api.php' + "?set-rating=true&type=" + this.type + "&id=" + this.data.id + "&grade=" + vote, (response) => {
                            ratingInfos = response
                            setRating(ratingInfos)
                        } )
                    } else {
                        // On click, ask API to cancel current vote and update rating display
                        ajaxGetRequest ('/map/api.php' + "?cancel-rating=true&type=" + this.type + "&id=" + this.data.id, (response) => {
                            ratingInfos = response
                            setRating(ratingInfos)
                        } )
                    }
