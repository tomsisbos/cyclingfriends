...
<body class="black-theme"> <?php
	...
	<div class="main"> <?php
		...
		<div class="container home-container end">
            ...
            <p><a href="<?= $router->generate('user-signup') ?>">新規登録専用ページ</a>にて新規アカウントのログイン、メールアドレスとパスワードを登録後、アカウント作成の手続きを完了させるには、登録時にご入力いただいたメールアドレス宛に自動送信された確認用メールの中にあるURLをクリックする必要があります。件名は「アカウントのメールアドレス確認」になっているメールをお探しください。</p>
