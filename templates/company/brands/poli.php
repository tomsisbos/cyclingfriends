...
<body> <?php
    ...
    <div class="brand container">
        ...
        <div class="container">
            ...
            <h3>最低注文枚数</h3>
            <p><strong>商品グループ別：10枚</strong>（例：半袖ジャージ6枚と長袖ジャージ4枚はグループ1の合計枚数が10枚になるのでＯＫです。仮に半袖ジャージが6枚でビブショーツが4枚の場合、商品グループが違うので枚数を増やす必要があります）</p>
            <p>一番お得になってくるのは20枚以上です。</p>
            <p><strong>商品別：ひとつの商品の合計枚数が5枚以下となる場合、単価に15%を追加</strong>させて頂きます。</p>
            <h3>追加注文制度</h3>
            <p>ご注文頂いてから1年以内に同じデザインでの追加注文は1枚から可能で、15%上乗せされるのは3枚以下の場合だけです。※但し、最初の注文で取引のあった商品（オプションも同じ）に限ります。また、第1回注文と同じ価格帯になります。</p>
            <h3>納期</h3>
