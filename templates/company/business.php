...
<body class="black-theme"> <?php
    ...
    <div class="container home-container end">
        <div class="container smaller">
            ...
            <div class="company-quote">Mission : <div class="company-quotemarks">"</div>持続可能な社会づくりに必要な価値観の改革を起こす<div class="company-quotemarks">"</div></div>
            <p>高齢化、人口減少や地方衰退など、日本が抱えている課題は様々。</p>
            <p>地球単位で見ると、気候変動や生物多様性の絶滅など、深刻な課題はもっと沢山。</p>
            <p>実は、これらすべてに共通点があります。それは、<strong>我々人間の消費活動の結果である</strong>ということです。</p>
            <p>森、石油やガスなど、限られた自然資源を費やし、汚染、二酸化炭素、集中型経済等の外部不経済を生み出してきた結果がこれまでの経済成長でもあり、これからの課題でもあります。</p>
            <p>つまり、我々がこれらの課題を「望んできた」と言わないまでも、少なくとも「選んできた」「良しとしてきた」わけです。</p>
            ...
            <p>しかし、経済成長を最終目的と控える価値観から離脱するということは、<strong>消費社会の成果物よりも、自然、伝統や文化の成果物に価値を与える</strong>世界観が必要であることは間違いないでしょう。</p>
            <p>この世界観を広げるために主な手段として選んだのが「自転車」。なぜなら、上記の課題全てに寄与できる優れものだからです。</p>
            <p>用のない地域を訪れ、値段のない自然を楽しむ：これは消費社会とは真逆の、サイクリストの不思議な志。</p>
            ...
            <div class="schema">
                <div class="schema-part">
                    ...
                    <div class="schema-table">
                        ...
                        <div class="schema-row">サイクリングツアーの企画／実施</div>
                ...
                <div class="schema-part">
                    ...
                    <div class="schema-table">
                        <div class="schema-row">オンラインサイクリングマップの開発</div>
