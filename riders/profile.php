...
include '../actions/riders/profile/bikeInfosAction.php';
include '../actions/riders/profile/bikeAction.php';
include '../actions/riders/profile/deleteBikeAction.php'; */
?>
...
<body>
	...
	<div class="container d-flex flex-column gap end"> <?php

		// Profile infos
		include '../includes/riders/profile/infos.php';		
