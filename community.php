					...
					<div class="rdr-card <?php if($connected_user->isFriend($rider)){ echo 'bg-friend'; }else{ echo 'bg-rider'; } ?>">
							<div class="rdr-card-inner">
								...
								<div class="rdr-container-left">
									...
									<div class="rdr-maininfos-section">
										<div class="rdr-sub">
											...
											<?php if ($rider->isFriend($connected_user)) { ?>
												<div>
								...
								<div class="rdr-container-buttons">
									<?php // If the rider is friend with connected user
									...
									<?php // If the rider has sent a request to connected user
									...
									<?php // If the rider is not friend with connected user (and is not connected user himself)
